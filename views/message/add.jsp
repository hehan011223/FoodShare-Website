        ...
        <div class="span12">
             ...
             <br>
                        <div class="block_contact_form">
                        	<form  action="addMsg.do" class="w_validation" method="post" onsubmit="return check()">
                            	<p>Send to</p>
                            	<div class="select">
                                   	<select class="custom_select" name="receiverId" id="receiverId">
                                   		<c:forEach items="${friends}" var="friend">
                                   			<option value="${friend.personId}">${friend.username }</option>
                                   		</c:forEach>
                                    </select>
                                </div>
                                <br>
                                <br>
                                <p>Subject</p>
                            	<div class="field"><input type="text" name="subject" id="subject"></div>
                            	<br>
                            	<br>
                                <p>Message</p>
...
<script type="text/javascript">
	var check = function() {
		...
		var body = $("#body").val();
		if(receiverId == null || eceiverId ==''){
			alert("You shoud add a friend firstly");
			return false;
		}
		if (subject == "" || body == "") {
			alert("the subject or message is empty!");
			return false;
		} else {
			alert("send a msg sucessfully!!")
			return true;
		}
	}
</script>
